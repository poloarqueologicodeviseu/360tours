'use strict';
  ...
  var scenes = APP_DATA.scenes.map(function(sceneData) {
    ...
    sceneData.linkviewHotspots.forEach(function(hotspot) {
    ...
    sceneData.infoboardHotspots.forEach(function(hotspot) {
